...
public interface IAppUserApiClient2
{
...
public class AppUserApiClient2 : ApiClientBase<AppUser>, IAppUserApiClient2
{
    public AppUserApiClient2(HttpClient httpClient)
        : base(httpClient)
    {
    }
