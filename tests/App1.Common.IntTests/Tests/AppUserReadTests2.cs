...
public class AppUserReadTestsFixture2 : IDisposable
{
	public AppUserReadTestsFixture2()
	{
...
public class AppUserReadTests2 : IClassFixture<AppUserReadTestsFixture2>, IDisposable
{
	#region Fields
	...
	public AppUserReadTests2(AppUserReadTestsFixture2 classFixture, ITestOutputHelper output)
	{
