...
function ChangelogComponent_For_12_For_8_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(listItem_r1);
  }
}
function ChangelogComponent_For_12_For_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 13)(1, "span", 14);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "ul");
    \u0275\u0275repeaterCreate(4, ChangelogComponent_For_12_For_8_For_5_Template, 2, 1, "li", null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const change_r2 = ctx.$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(change_r2.type);
    \u0275\u0275advance(2);
    \u0275\u0275repeater(change_r2.list);
  }
}
function ChangelogComponent_For_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 9)(1, "div")(2, "h2", 10);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275element(6, "hr", 12);
    \u0275\u0275repeaterCreate(7, ChangelogComponent_For_12_For_8_Template, 6, 1, "div", 13, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r3 = ctx.$implicit;
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(item_r3.version);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", item_r3.releaseDate, " ");
    \u0275\u0275advance(2);
...
var ChangelogComponent = class _ChangelogComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ChangelogComponent, selectors: [["changelog"]], decls: 13, vars: 0, consts: [[1, "flex", "min-w-0", "flex-auto", "flex-col"], [1, "bg-card", "flex", "flex-0", "flex-col", "border-b", "p-6", "dark:bg-transparent", "sm:flex-row", "sm:items-center", "sm:justify-between", "sm:px-10", "sm:py-8"], [1, "min-w-0", "flex-1"], [1, "flex", "flex-wrap", "items-center", "font-medium"], [1, "whitespace-nowrap", "text-primary-500"], [1, "mt-2"], [1, "truncate", "text-3xl", "font-extrabold", "leading-7", "tracking-tight", "sm:leading-10", "md:text-4xl"], [1, "flex-auto", "p-6", "sm:p-10"], [1, "prose", "prose-sm", "max-w-5xl"], [1, "bg-card", "mb-12", "rounded-2xl", "p-8", "shadow"], [1, "my-0"], [1, "text-secondary", "text-md", "font-semibold"], [1, "mt-6"], [1, "mt-8"], [1, "text-secondary", "bg-default", "inline-flex", "rounded", "px-3", "py-1", "font-bold"]], template: function ChangelogComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275repeaterCreate(11, ChangelogComponent_For_12_Template, 9, 2, "div", 9, \u0275\u0275repeaterTrackByIdentity);
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(11);
        \u0275\u0275repeater(ctx.changelog);
      }
    }, encapsulation: 2, changeDetection: 0 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ChangelogComponent, { className: "ChangelogComponent", filePath: "src/app/modules/admin/docs/changelog/changelog.ts", lineNumber: 9 });
})();

// src/app/modules/admin/docs/changelog/changelog.routes.ts
var changelog_routes_default = [
  {
    path: "",
...
export {
  changelog_routes_default as default
};
//# sourceMappingURL=chunk-OECKO4QX.js.map
